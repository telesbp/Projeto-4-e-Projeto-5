    ...
    return(
        ...
        <NavBarCollapseStyled id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <CustomButton className="mt-2 mt-lg-0" variant="primary">Criar nova conta</CustomButton>
        </Nav>
            <Form className="d-flex">
              <Form.Control
                ...
                aria-label="Search"
              />
              <CustomButton variant="outline-primary" className="mt-2 mt-lg-0">Pesquisar</CustomButton>
            </Form>
