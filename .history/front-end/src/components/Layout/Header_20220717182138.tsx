    ...
    return(
        ...
        <Container fluid>
          <Navbar.Brand to="/" as={Link}>
            <img src={isTransparent ? LogoBrandBlack : LogoBrand} alt="MovArt" width={170} height={80}/>
          </Navbar.Brand>
          ...
          <Nav className="ms-auto">
            ...
            <Form className="d-flex">
              <Form.Control
                ...
                aria-label="Search"
              />
              <CustomButton variant="outline-primary" className="mt-2 mt-lg-0 ms-lg-4">Pesquisar</CustomButton>
            </Form>
