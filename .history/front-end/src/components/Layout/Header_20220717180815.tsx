    ...
    return(
        ...
        <NavBarCollapseStyled id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <CustomButton className="mt-2" variant="primary">Tenho uma conta</CustomButton>
            <CustomButton className="mt-2 mb-2" variant="primary">Criar nova conta</CustomButton>
        </Nav>
...
`
const NavLinkStyled = style(Nav.Link)`
