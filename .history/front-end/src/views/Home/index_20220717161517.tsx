    ...
    return(
        <Banner className="vh-100">
            <Container className="h-100 d-flex flex-column justify-content-center align-items-center align-items-lg-start">
                ...
                <CustomButton loading size="lg" variant="primary" className="mt-auto mt-lg-3 mb-2">Fazer Login</CustomButton>
                <CustomButton size="lg" variant="outline-primary" className="mb-4">Criar Conta</CustomButton>
            </Container>
        </Banner>
    )
}
